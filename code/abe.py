...
def RUNtest(data, nwalkers, nsteps, i_guess, gflag, bflag,  eq='All', uwmprior=False,   moderr=False,  nsig=1,  namemc=None,  namecont=None):
...
def main():
    ...
    if(args.abe):
        ...
        samples = RUNtest(data, nwalkers, nsteps, i_guess, gflag, bflag, eq, args.uwmprior,  moderr, nsig,  namemc, namecont)
