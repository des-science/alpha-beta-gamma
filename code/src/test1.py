...
def main():
    ...
    print("Difference Rho0p <ep'ep'>")
    print(rho0p - urho0p)
    print("Difference Rho1p <q'q'>")
    print(rho1p - urho1p)
    print("Difference Rho3p <w'w'>")
    print(rho3p - urho3p)
    ...
    meande2 = np.mean(np.sqrt(de1**2 + de2**2))
    print(meande, meande2 )
    print("<w>^2")
    meanw = np.mean(w1**2) + np.mean(w2**2)
    meanw2 = np.mean(np.sqrt(w1**2 + w2**2))
    print(meanw, meanw2)
    print("<p_e>^2")
    meanpe = np.mean(p_e1**2) + np.mean(p_e2**2)
    meanpe2 = np.mean(np.sqrt(p_e1**2 + p_e2**2))
