...
def plot_overall_rho(work,  outpath):

    print 'Plot overall rho stats'

    base_keys = ['griz', 'riz', 'ri', 'g', 'r', 'i', 'z', 'ir', 'irz', 'girz' ]
    ...
    for key in keys:
        ...
        if len(stats) > 26:
            ...
            #plt.savefig('rho2_' + key + '.png')
            plt.savefig(outpath +'/corrtt_' + key + '.png')
