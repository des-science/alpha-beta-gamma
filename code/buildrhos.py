...
def parse_args():
    ...
    parser.add_argument('--rhosjnfile',
                        default='/home/dfa/sobreira/alsina/alpha-beta-gamma/code/correlations/allrhosp_jk.fits',
...
def main():
    ...
    namesout=[ 'RHO0','RHO1', 'RHO2', 'RHO3', 'RHO4', 'RHO5']
    if args.xim:
        args.rhosjnfile = '/home/dfa/sobreira/alsina/alpha-beta-gamma/code/correlations/allrhosm_jk.fits'
    alldata =  fitsio.read(args.rhosjnfile, ext=1)
    ...
    for nam in namesout:
        ...
        for i,j in bin_pairs:
            ...
            #check jk formula for the variance //np.cov divide by n-1
            covmat[i,j] = ((len(a)-1)**2)/(len(a))*np.cov(a,b)[0][1]
        ...
        angarray = np.exp(alldata['THETA'][alldata['JKR']==0])
