...
START_PATH=/home/dfa/sobreira/alsina/alpha-beta-gamma/cosmosis_pipe/runs/contaminatedpar32
cd $START_PATH

mpirun --mca btl vader,tcp,self -n 32 $INSTALL/cosmosis/cosmosis/bin/cosmosis --mpi $START_PATH/run2_d_l.ini
